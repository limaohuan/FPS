...
void AFPS_ProjectCharacter::NotifyControllerChanged()
{
...
void AFPS_ProjectCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
...
void AFPS_ProjectCharacter::AddScore(int Point)
{
	Score += Point;
	FString AddingScore = FString::Printf(TEXT("Score updated: %d"), Score);
	GEngine->AddOnScreenDebugMessage(-1, 1.0f, FColor::White, AddingScore);
}

int AFPS_ProjectCharacter::GetScore()
{
	return Score;
}
